...
const Component3 = ({ changePage, values }) => {
  const data = useContext(Theme2);
  let input1  = " ";
  let input2 = " ";
  if (data.form3 != undefined) {
    input1 = data.form3.field1;
    input2 = data.form3.field2;
  }
