...
const Component2 = ({ changePage, values }) => {
  const data = useContext(Theme1);
  let input1  = " ";
  let input2 = " ";
  console.log("form2 values",data.form2)
  if (data.form2 != undefined) {
    input1 = data.form2.field1;
    input2 = data.form2.field2;
  }
